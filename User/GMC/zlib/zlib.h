...
/*
   ...
   is as in _open ("rb" or "wb") but can also include a compression level
...
/*
   ...
   fileno (in the file has been previously opened with _open).
   The mode parameter is as in gzopen.
     The next call of gzclose on the returned gzFile will also close the
   file descriptor fd, just like _close(fdopen(fd), mode) closes the file
...
/*
   ...
   uncompressed data stream. The whence parameter is defined as in _lseek(2);
