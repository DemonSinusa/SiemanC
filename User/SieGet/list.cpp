...
HEADER_DESC list_hdr={0,0,0,0, 0, 0, LGP_NULL};

const int list_softkeys[]={0,1,2};

static const ML_MENU_DESC list_desc=
{
  8, list_keyhook, list_ghook, 0,
  list_softkeys,
  &list_skt,
  0x200 + 0x11,
  list_itemhndl,
...
void List::Show()
{
  ...
  gui_id = CreateMultiLinesMenu(0, 0, &list_desc, &list_hdr, 0, DownloadHandler::Top->GetNumOfDownloads());
}
...
HEADER_DESC list_options_hdr={0,0,0,0,0,0,LGP_NULL};
