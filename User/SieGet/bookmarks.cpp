...
HEADER_DESC bookmarks_menu_hdr={0,0,0,0, 0, 0, LGP_NULL};

const int bookmarks_menu_softkeys[]={0,1,2};

const MENU_DESC bookmarks_menu_desc=
{
  8, bookmarks_menu_keyhook, bookmarks_menu_ghook, 0,
...
void Delete(GUI *data)
{
  ...
  if(options->il->type==BookmarksList::IS_FILE)
    _unlink(options->il->fullname, &io_error);
  GeneralFunc_flag1(options->gui_id, 1);
}
...
HEADER_DESC bookmarks_options_hdr={0,0,0,0,0, 0 ,LGP_NULL};

MENUITEM_DESC bookmarks_options_items[OPTIONS_ITEMS_N]=
{
  {0, 0, LGP_NULL, 0, 0, MENU_FLAG3, MENU_FLAG2},
  {0, 0, LGP_NULL, 0, 0, MENU_FLAG3, MENU_FLAG2},
  {0, 0, LGP_NULL, 0, 0, MENU_FLAG3, MENU_FLAG2},
  {0, 0, LGP_NULL, 0, 0, MENU_FLAG3, MENU_FLAG2},
};
...
HEADER_DESC bookmarks_input_hdr={0,0,0,0,0, 0,LGP_NULL};
