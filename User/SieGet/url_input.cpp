...
HEADER_DESC urlinput_hdr={0,0,0,0, 0, 0, LGP_NULL};
...
void URLInput::Show(const char * url_str, const char * ref_str)
{
  ...
  str_2ws(ws, (char*)CFG_DOWNLOADS_FOLDER, 511);
  PrepareEditControl(&ec);
  ConstructEditControl(&ec, ECT_NORMAL_TEXT, ECF_APPEND_EOL, ws, 511);
