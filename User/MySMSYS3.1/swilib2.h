...
///Аналог RAMCAP, но бе?запарк?на?рамо?
...
__swi __arm int SendSMS(WSHDR *ws,const char *num,int cepid,int msg,int flag);
//thumb
...
//thumb
//pattern=E9 21 C9 00 41 1A 80 B5 3C 20 +1

#pragma swi_number=0x236
__swi __arm int GetLunarAnimal(int year);
//thumb
...
//thumb
//pattern=02 68 53 01 9A 18 38 32 12 02 12 0A+1
...
//arm
//pattern_ELKA=??,??,??,e9,??,??,??,e2,??,??,??,e1,??,??,??,e1,??,??,??,e2,??,??,??,e2,??,??,??,e3,??,??,??,??,??,??,??,E1,??,??,??,E1,??,??,??,EB,??,??,??,E3,??,??,??,0A,??,??,??,E1,??,??,??,??,??,??,??,E3,??,??,??,0A,??,??,??,E1
//thumb
//pattern_NEWSGOLD=??,B5,??,1C,??,1C,??,B0,??,A9,??,A8,??,22,??,??,??,??,??,1C,??,1C,??,??,??,??,??,28,??,D0,??,1C,??,??,??,??,??,28,??,D0,??,95,??,1C+1
//arm
//pattern_SGOLD=??,??,??,e9,??,??,??,e2,??,??,??,e1,??,??,??,e1,??,??,??,e2,??,??,??,e2,??,??,??,e3,??,??,??,??,??,??,??,E1,??,??,??,E1,??,??,??,EB,??,??,??,E3,??,??,??,0A,??,??,??,E1,??,??,??,??,??,??,??,E3,??,??,??,0A,??,??,??,E1
...
/* //删除，直接使用有风险,可能会造成和系统的冲突,读取可以直接打开sms.dat,删除可以使用DeleteSMS
#pragma swi_number=0x82A0
__swi __arm short *RAM_SMS_dat_FileHandler();
//arm
//pattern_NSG=&(??,4E,??,3E,??,68,??,28,??,D0,??,27,??,1C,??,20,??,??,??,??,??,28,??,D0)-8

#pragma swi_number=0x82A1
__swi __arm short *RAM_WB_dat_FileHandler();
//arm
//pattern_NSG=&(??,4E,??,3E,??,68,??,28,??,D0,??,27,??,1C,??,20,??,??,??,??,??,28,??,D0)-6

#pragma swi_number=0x82A2
__swi __arm short *RAM_EMS_Admin_dat_FileHandler();
//arm
...
__swi __arm int SetSmsStatus(int index, int type); //return 0x3E8, type, 1: new to read, 3: read to new
//thumb
